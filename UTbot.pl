:-dynamic navigation/2, navPoint/3, prevLocation/3, self/3, orientation/3, status/2, score/3, currentWeapon/2, weapon/3,
	...
	goHomeWithFlag/1, goOther/1, goRack/1, goItem/2, goHealth/2, goArmor/2, t/0, pu/1, eL/2, temp/1, tempEL/2, goLastKnown/1, locationOfFlag/3, goGrabEnemy/1, atkRad/1, goRandom/1, goHelp/1, goLocationKill/2, path/4, path/2.
