:-dynamic 
	...
	angle/3, viewAngle/1, lastAngleUpdater/1, ownLocation/3, 
	lookingAt/1, goLocationFlag/1, goLocationHelp/2, 
	goLocationFlagEnemy/1, goHomeWithFlag/1, goRandom/1,
	goLocationHelp/1, goLocationKill/1, goToEnemyBase/1, 
	closeToEnemyBaseNavPoint/1, closeToOurBaseNavPoint/1.
